...
def play_roulette(fib_sequence, games):
    ...
    for i in range(1, games + 1):
        ...
        balance_history.append((i, total_profit, total_win, total_loss, spin_result, total_bet, street1_bet, win, loss))
...
print("{:<12} {:<10} {:<10} {:<10} {:<14} {:<9} {:<10} {:<6} {:<6}".format("Hand Number", "Total Win", "Total Loss", "Balance", "Winning Number", "Total Bet", "Street 1 Bet", "Win", "Loss"))
for item in balance_history:
    print("{:<12} {:<10} {:<10} {:<10} {:<14} {:<9} {:<10} {:<6} {:<6}".format(item[0], item[2], item[3], item[1], item[4], item[5], item[6], item[7], item[8]))
